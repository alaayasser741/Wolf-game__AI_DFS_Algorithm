...
namespace WindowsFormsApp1
{
    internal class DFS
    {
            ...
            public IEnumerable<State> GetNextStates()
            {
                ...
                foreach (var move in PossibleMoves)
                {
                    var newState = new State(
                        new Point(Wolf.X + move.X, Wolf.Y + move.Y),
                        new Point(Goat.X + move.X, Goat.Y + move.Y),
                        new Point(Cabbage.X + move.X, Cabbage.Y + move.Y),
                        new Point(Farmer.X + move.X, Farmer.Y + move.Y),
                        !IsLeft
                    );
        ...
        public static bool IsSafe(State state)
        {
            ...
            private static readonly List<Point> PossibleMoves = new List<Point>
    {
        ...
        new Point(-1, 0),  // Left
            ...
            private List<State> steps = new List<State>();
